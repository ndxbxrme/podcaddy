angular.module('pod').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('directives/addfeed/addfeed.html',
  ...
  $templateCache.put('directives/feed/feed.html',
  ...
  $templateCache.put('directives/pod-controls/pod-controls.html',
  ...
  $templateCache.put('directives/pod/pod.html',
  ...
  $templateCache.put('routes/main/main.html',
    "<input type=\"text\" ng-model=\"name\" ng-change=\"triggerScroll()\" placeholder=\"Search Pods\" class=\"search\"/><pod ng-repeat=\"pod in pods = (getPods() | listened:getFilter()) | filter:name\"></pod><h3 ng-show=\"!pods.length\" class=\"alert\">Nothing to listen to?  Click <a href=\"/feeds\">here </a>to add some feeds </h3>"
  );
