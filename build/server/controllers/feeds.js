(function() {
  ...
  module.exports = function(ndx) {
    ...
    doPoll();
    ndx.app.post('/api/pods', function(req, res) {
    ...
    ndx.app.post('/api/feeds', function(req, res) {
      var data, props;
      props = [];
      if (req.user) {
        props.push(req.user._id);
    ...
    ndx.app.post('/api/report-listen', function(req, res) {
      var prevListen;
    ...
    ndx.app.post('/api/unsubscribe', function(req, res) {
      if (req.user && req.body.feedId) {
